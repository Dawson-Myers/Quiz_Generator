...
const numQuestion = parseInt(prompt("Enter the number questions: "))
const questions = loadQuestions();
const randomQuestions = getRandomQuestions(questions, numQuestion)
...
console.log("Score:", Math.round((correct / numQuestion) * 100) + "%")
